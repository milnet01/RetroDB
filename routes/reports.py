...
def api_reports_naming_check():
    ...
    try:
        ...
        logger.error(f"Naming check error: {e}")
...
def api_reports_name_mismatch():
    ...
    try:
        ...
        logger.error(f"Name mismatch check error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'}), 500
...
def api_reports_multidisc_scan():
    ...
    try:
        ...
        logger.error(f"Multi-disc scan error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'}), 500
...
def api_reports_organize_multidisc():
    ...
    try:
        ...
        logger.error(f"Organize multi-disc error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'}), 500
...
def api_reports_rename_to_scraped():
    ...
    try:
        ...
        logger.error(f"Rename to scraped error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'}), 500
