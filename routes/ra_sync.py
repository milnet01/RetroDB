...
def api_refresh_retroachievements():
    ...
    try:
        ...
        logger.error(f"Refresh RetroAchievements error: {e}")
        return jsonify({
            'success': False,
...
def api_refresh_retroachievements_system(system_id):
    ...
    try:
        ...
        logger.error(f"Refresh RetroAchievements error for system {system_id}: {e}")
        return jsonify({
            'success': False,
            'error': 'An internal error occurred'
        }), 500
...
def api_clear_ra_data_system(system_id):
    ...
    try:
        ...
        logger.error(f"Clear RA data error for system {system_id}: {e}")
        return jsonify({
            'success': False,
            'error': 'An internal error occurred'
        }), 500
...
def api_clear_ra_data_all():
    ...
    try:
        ...
        logger.error(f"Clear all RA data error: {e}")
        return jsonify({
            'success': False,
            'error': 'An internal error occurred'
        }), 500
