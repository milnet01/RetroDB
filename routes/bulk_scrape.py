...
def api_bulk_scrape():
    ...
    try:
        ...
        # Try to scrape using hybrid scraper with user's priority order
        try:
            ...
            logger.error(f"Bulk scrape error for game {game_id}: {e}")
            return jsonify({'success': False, 'error': 'An internal error occurred'})

    except Exception as e:
        logger.error(f"Bulk scrape API error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'})
...
def api_bulk_scrape_job_start():
    ...
    try:
        ...
        logger.error(f"Bulk scrape job start error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'})
...
def api_bulk_scrape_job_status():
    ...
    try:
        ...
        logger.error(f"Bulk scrape job status error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'})
...
def api_bulk_scrape_job_pause():
    ...
    try:
        ...
        logger.error(f"Bulk scrape job pause error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'})
...
def api_bulk_scrape_job_resume():
    ...
    try:
        ...
        logger.error(f"Bulk scrape job resume error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'})
...
def api_bulk_scrape_job_cancel():
    ...
    try:
        ...
        logger.error(f"Bulk scrape job cancel error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'})
...
def api_bulk_scrape_job_cancel_queued(job_id):
    ...
    try:
        ...
        logger.error(f"Bulk scrape cancel queued error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'})
...
def api_bulk_scrape_job_cancel_all_queued():
    ...
    try:
        ...
        logger.error(f"Bulk scrape cancel all queued error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'})
...
def api_bulk_scrape_job_promote_queued(job_id):
    ...
    try:
        ...
        logger.error(f"Bulk scrape promote queued error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'})
...
def api_bulk_scrape_job_demote_queued(job_id):
    ...
    try:
        ...
        logger.error(f"Bulk scrape demote queued error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'})
...
def api_bulk_scrape_job_swap_running(job_id):
    ...
    try:
        ...
        logger.error(f"Bulk scrape swap running error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'})
...
def api_bulk_scrape_job_demote_running():
    ...
    try:
        ...
        logger.error(f"Bulk scrape demote running error: {e}")
        return jsonify({'success': False, 'error': 'An internal error occurred'})
